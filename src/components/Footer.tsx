        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link to="/trips" className="text-gray-300 hover:text-white transition-colors">Tours</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/trips/kedarnath" className="text-gray-300 hover:text-white transition-colors">Kedarnath</Link>
              </li>
              <li>
