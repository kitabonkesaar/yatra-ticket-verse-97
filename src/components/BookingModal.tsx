...
const BookingModal: React.FC<BookingModalProps> = ({
  ...
  return <div className="fixed inset-0 bg-black/30 z-50 flex items-center justify-center animate-fade-in">
      <div className="bg-white w-full max-w-md rounded-xl shadow-lg p-6 relative animate-scale-in">
        ...
        {step === "success" && <div className="flex flex-col items-center py-8 animate-scale-in">
        ...
        {step === "ticket" && <DigitalTicket booking={{
        passengers: [{
          name: form.name,
          age: form.age,
