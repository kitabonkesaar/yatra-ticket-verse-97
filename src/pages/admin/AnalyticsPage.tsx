...
const tourDistribution = [
  ...
  { name: "East India", value: 200 },
  { name: "West India", value: 250 },
];
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-500">View detailed analytics about your business</p>
      </div>
        ...
        <TabsContent value="overview" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Number of bookings made each month
              </CardDescription>
            </CardHeader>
        ...
        <TabsContent value="bookings" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Website traffic for the past week
              </CardDescription>
            </CardHeader>
            <CardContent className="pl-2">
              <ResponsiveContainer width="100%" height={300}>
