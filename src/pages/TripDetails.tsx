...
const mockTrips = [
  {
    ...
    busType: "Traveller",
    itinerary: [
      { day: 1, highlight: "Haridwar - Guptkashi", details: "Pickup from Haridwar & drive to Guptkashi. Night stay." },
      { day: 2, highlight: "Guptkashi - Sonprayag - Kedarnath", details: "Early drive, trek to Kedarnath. Darshan & stay." },
      { day: 3, highlight: "Kedarnath - Sonprayag - Guptkashi", details: "Return trek, drive to Guptkashi. Night stay." },
      { day: 4, highlight: "Guptkashi - Haridwar", details: "Return to Haridwar. Trip ends." },
    ],
          ...
          {showPayment ? (
            <div className="flex flex-col items-center justify-center py-10 animate-fade-in">
              ...
              <div className="rounded-xl bg-gradient-to-tr from-orange-100 to-white shadow-lg max-w-xs w-full p-4 flex flex-col items-center gap-2 animate-scale-in">
                ...
                <Button
                  className="mt-4 w-full bg-bharat-orange hover:bg-bharat-orange/90 pulse"
                  size="lg"
                  onClick={() => alert("Redirecting to Razorpay... (demo)")}
                >
                  Pay with Razorpay →
                </Button>
